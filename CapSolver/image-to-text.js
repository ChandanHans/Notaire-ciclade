...
(() => {
  ...
  var Z = (e, t, n) => (
    ...
    Ve(
      t || !e || !e.__esModule
        ? X(n, "default", { value: e, enumerable: !0 })
        : n,
      e
    )
  );
  var ue = Y((Et, B) => {
    ...
    i.prototype.emit = function (t) {
      ...
      if (typeof p == "function") ee(p, this, n);
      else
    ...
    i.prototype.once = function (t, n) {
      return _(n), this.on(t, ae(this, t, n)), this;
    };
    i.prototype.prependOnceListener = function (t, n) {
      return _(n), this.prependListener(t, ae(this, t, n)), this;
    };
    i.prototype.removeListener = function (t, n) {
      var r, o, a, s, c;
      if ((_(n), (o = this._events), o === void 0)) return this;
    ...
    i.prototype.removeAllListeners = function (t) {
      ...
      if (arguments.length === 0) {
        ...
        for (o = 0; o < a.length; ++o)
          (s = a[o]), s !== "removeListener" && this.removeAllListeners(s);
        return (
    ...
    function Qe(e, t) {
      return new Promise(function (n, r) {
        ...
        le(e, t, a, { once: !0 }), t !== "error" && Je(e, o, { once: !0 });
      });
    }
    function Je(e, t, n) {
  ...
  var Ye = {
      ...
      string: (e) => 2 * e.length,
      object: (e) =>
        e ? Object.keys(e).reduce((t, n) => K(n) + K(e[n]) + t, 0) : 0,
    },
    K = (e) => Ye[typeof e](e),
          ...
          let c = [],
            p = (u) => {
              if (u !== void 0 && u._chunkSplit) {
                let d = u._chunkSplit;
                (c = [...c, ...u.data]), d.lastChunk && (this.off(o, p), a(c));
              } else this.off(o, p), a(u);
            };
          this.on(o, p);
          try {
            let u = t.map((d) => ({
                  ...
                  this.wall.send([
                    {
                      event: n.event,
                      payload: {
                        _chunkSplit: { count: C, lastChunk: I === C - 1 },
                        data: P.splice(0, j),
                      },
                    },
                  ]);
  ...
  var Oe = Z(he());
  var Ze = chrome.runtime.getURL("assets/config.js"),
    be,
    O = (be = globalThis.browser) != null ? be : globalThis.chrome;
  async function et() {
    ...
    return (
      (t.blackUrlList = He.split(",")),
      O.storage.local.set({ defaultConfig: t }),
      t
    );
  }
  var M = {
  ...
  async function Ce() {
    ...
    for (let n of t)
      if (!(n === "proxyType" && !ge[n].includes(e[n]))) {
        {
          if (n.endsWith("Mode") && !ge.mode.includes(e[n])) continue;
          if (n === "port") {
    ...
    g = {
      ...
      async set(e) {
        let t = await g.getAll(),
          n = g.joinConfig(t, e);
        return O.storage.local.set({ config: n });
      },
      joinConfig(e, t) {
        let n = {};
  ...
  function y(e, t) {
    ...
    return (
      "KeyboardEvent" in window
        ? (n = new window.KeyboardEvent(t, { bubbles: !0, cancelable: !1 }))
  ...
  function D(e) {
    ...
    e.style.backgroundImage
      ...
      : e.style.background && (n = e.style.background),
      (r = n.split(","));
    let o = r.find((a) => a.startsWith("url("));
    return o
      ? ((t = o.slice(5, o.length - 2)), t.startsWith("blob:") ? t.slice(5) : t)
      : "";
  }
  function it() {
    let e = "[" + N + "]",
    ...
    return (
      Array.from(t).forEach((r) => {
        let o = r.tagName,
          a = "";
        o === "IMG" ? (a = r.getAttribute("src")) : (a = D(r)), a && n.push(r);
      }),
      n
    );
  }
  ...
  function ft(e, t) {
    ...
    return (
      t.forEach((r) => {
        ...
        a && n.push({ image: a, result: r, id: o });
      }),
      n
    );
  }
  async function pt(e, t) {
    let n = await ut(e.image),
      r = { body: n.slice(n.indexOf(";base64,") + 8), id: e.id },
      o = { action: "solver", captchaType: "textCaptcha", params: r };
    chrome.runtime.sendMessage(o).then((a) => {
      var s;
      if (
        !(a != null && a.response) ||
        ((s = a == null ? void 0 : a.response) == null ? void 0 : s.error)
      ) {
        xe++, xe <= t && F.splice(F.indexOf(e.id), 1);
        return;
      }
      update_result(a.response);
    });
  }
  var dt = [
      { value: "mul", label: "\xD7" },
  ...
  function gt(e) {
    return e[e.length - 1] !== "="
      ? !1
      : dt.find((n) => e.indexOf(n.label) !== -1).value;
  }
  function update_result(e) {
    var a;
    let t = (a = e.response) == null ? void 0 : a.solution, r = document.querySelector(`input[${L}]`);
    if (!r) return;
    let o = gt(t.text);
    if (!o) V(r, t.text);
    else {
    ...
    chrome.runtime.sendMessage({ action: "solved" });
  }
  function Te(e) {
  ...
  function we(e, t) {
    let n = e.length;
    for (let r = 0; r < n; r++)
      F.includes(e[r].id) || (pt(e[r], t), F.push(e[r].id));
  }
  var $,
    b,
    k,
    ...
    G = 0,
    Me,
    E = (Me = globalThis.browser) != null ? Me : globalThis.chrome;
  function Le() {
  ...
  function ke(e) {
    ...
    if (r) t = `${n}#${r}`;
      ...
      for (let s = 0; s < o.length; s++) {
        let c = o[s];
        ["id", "class", "onclick"].includes(c.name) ||
          (a += "[" + c.name + '="' + c.value + '"]');
      }
      t = `${n}${a}`;
    }
  ...
  async function Ct(e) {
    ...
    let t = ke(e),
      ...
      s = Object.assign({}, a, { image: t });
    o.hasOwnProperty(n) ? Object.assign(o[n], s) : (o[n] = s),
      E.storage.local.set({ imageUrls: o });
  }
  async function vt(e) {
    let t = ke(e),
      n = z(),
      ...
      a = o[n],
      s = Object.assign({}, a, { input: t });
    (o[n] = s), E.storage.local.set({ imageUrls: o });
  }
  function Ee(e) {
    let t = e.indexOf("[");
  ...
  async function yt(e) {
    ...
    Ee(e) === "attr"
      ...
      : (t = document.getElementById(e.slice(e.indexOf("#") + 1))),
  ...
  async function wt(e) {
    !e.useCapsolver ||
      !e.enabledForImageToText ||
      !e.apiKey ||
      (e.enabledForBlacklistControl && e.isInBlackList) ||
      (await ye(e.textCaptchaDelayTime),
      setInterval(async () => {
        let t = Te(e);
  ...
  U = window.setInterval(async () => {
    ...
    !e.isInit || (wt(e), window.clearInterval(U));
  }, 100);
  Le();
  ...
  var Mt = setInterval(function () {
      document.readyState === "complete" && (Ae(), clearInterval(Mt));
    }, 1e3),
    Ne = (0, Oe.bexContent)((e) => {});
  var Q = chrome.runtime.connect({ name: "contentScript" }),
    Fe = !1;

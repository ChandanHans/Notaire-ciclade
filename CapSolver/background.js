...
(() => {
  ...
  var T = (e, t, n) => (Se(e, typeof t != "symbol" ? t + "" : t, n), n);
  var ae = V((ft, B) => {
    "use strict";
    ...
    function Fe(e, t) {
      return new Promise(function (n, a) {
        ...
        ne(e, t, s, { once: !0 }), t !== "error" && Ke(e, o, { once: !0 });
      });
    }
    function Ke(e, t, n) {
  ...
  var Be = {
      ...
      string: (e) => 2 * e.length,
      object: (e) =>
        e ? Object.keys(e).reduce((t, n) => q(n) + q(e[n]) + t, 0) : 0,
    },
    q = (e) => Be[typeof e](e),
                  ...
                  this.wall.send([
                    {
                      event: n.event,
                      payload: {
                        _chunkSplit: { count: w, lastChunk: I === w - 1 },
                        data: F.splice(0, K),
                      },
                    },
                  ]);
  ...
  var je = chrome.runtime.getURL("assets/config.js"),
    le,
    U = (le = globalThis.browser) != null ? le : globalThis.chrome;
  async function qe() {
    ...
    return (
      (t.blackUrlList = ve.split(",")),
      U.storage.local.set({ defaultConfig: t }),
      t
    );
  }
  var L = {
    ...
    g = {
      ...
      async set(e) {
        let t = await g.getAll(),
          n = g.joinConfig(t, e);
        return U.storage.local.set({ config: n });
      },
      joinConfig(e, t) {
        let n = {};
  ...
  var h = class {
    ...
    static async API(t) {
      ...
      return new h({ apiKey: n.apiKey, ...t });
    }
    ...
    async createRecognitionTask(t) {
      ...
      if (
        ...
        throw new Error(
          ((d = r.data) == null ? void 0 : d.errorCode) ||
            "createTask fail\uFF01"
        );
  ...
  function He(e) {
    chrome.contextMenus.update("capsolver-mark-image", { enabled: e });
  }
  function We(e) {
    chrome.contextMenus.update("capsolver-mark-result", { enabled: e });
  }
  function O(e, t) {
    var a;
    ...
    return (
      g.getAll().then((o) => {
        switch (a) {
          ...
          case "solved":
            console.log("hello");
            me({ response: { action: "solved", callback: o.solvedCallback } });
            break;
          case "updateMenu":
            M(t.tab.id);
            break;
  ...
  var ye,
    ge = (ye = globalThis.browser) != null ? ye : globalThis.chrome;
  async function me(e) {
    let t = await ge.tabs.query({ currentWindow: !0, active: !0 });
  ...
  async function Xe(e) {
    ...
    let t = await h.API();
    return (
      ((n = e.websiteURL) == null ? void 0 : n.indexOf("tbi.com.iq")) !== -1 &&
      ...
      await t.createTaskResult({
        task: {
          ...
          metadata: { pageURL: C.pageURL, title: C.title },
        },
      })
    );
  }
  ...
  async function st(e) {
    return await (
      ...
      task: { type: "ImageToTextTask", body: e.body, websiteURL: e.url },
    });
  }
  async function rt(e) {
    return await (
  ...
  var we,
    H = (we = globalThis.browser) != null ? we : globalThis.chrome,
    N = "";
  async function it() {
  ...
  chrome.runtime.onConnect.addListener(async () => {
    N || (N = await it()), H.storage.local.set({ version: N });
  });
